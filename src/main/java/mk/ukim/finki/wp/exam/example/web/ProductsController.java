...
//cekor 24
@Controller //anotacija controller
public class ProductsController {
    ...
    // da se mapira / da vrati list.html i da se prikazat site produkti
    //list category categories..                                                                                                    //da se dodade model
    // od zadacata da se mapira na "/" i "/products"
    @GetMapping({"/","/products"})
    ...
    //sledno
    @GetMapping("/products/add") // getmapping zatoa sto samo prikazuvame forma
